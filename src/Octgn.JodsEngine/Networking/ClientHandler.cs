...
namespace Octgn.Networking
{
    public sealed class Handler
    {
        ...
        /// <seealso cref="Play.Actions.CreateCard"> for a more efficient way to insert cards inside one group.</seealso>
        ...
        /// <seealso cref="Play.Actions.CreateCard"> to add cards to several groups</seealso>
