...
partial class TableControl : GroupControl
{
    ...
    // }
    //
    internal async Task ResetBackground()
    {
        if (Program.GameEngine.Definition.Table.Background != null)
            await SetBackground(Program.GameEngine.Definition.Table);
    }
    
    internal async Task SetBackground(Group tableDef)
    {
        // await SetBackground(tableDef.Background, tableDef.BackgroundStyle);
        MyHelper.NotImplemented();
    }
    
    
    internal async Task SetBackground(IStorageFile file, BackgroundStyle bs)
    {
        var bim =await file.BitmapFromFile();
    ...
    //                                                                                         <TableKeyEventArgs>),
    //                                                                                     typeof(TableControl));
    public static readonly RoutedEvent<RoutedEventArgs> TableKeyEvent =
        RoutedEvent.Register<TableControl, RoutedEventArgs>(
            nameof(TableKeyEvent), 
