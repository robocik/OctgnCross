    ...
    public class ConnectionBaseTests : TestBase
    {
        ...
        public void Equals() {
            ...
            using (var conB = new InMemoryConnection(new FakeHandshaker("conB"), serializer, clientB)) {
                ClassicAssert.False(conA.Equals(conB));
                ClassicAssert.True(conA.Equals(conA));
            }
        }
        ...
        public void Initialize_SetsClient() {
            ...
            using (var conA = new InMemoryConnection(new FakeHandshaker("conA"), serializer, client)) {
                ClassicAssert.AreEqual(conA.Client, client);
            }
        }
        ...
        public async Task InMemoryTest() {
            ...
            using (var conB = new InMemoryConnection(new FakeHandshaker("conB"), serializer, clientB)) {
                ...
                ClassicAssert.AreEqual(0, conA.StillAwaitingAck);
                ClassicAssert.AreEqual(0, conB.StillAwaitingAck);

                ClassicAssert.AreEqual(1000, conACounter);
                ClassicAssert.AreEqual(1000, conBCounter);
            }
        }
    }
